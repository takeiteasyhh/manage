...
function successState(res) {
  // --todo 路径要改
  let loginUrl = process.env.NODE_ENV==="production"?"/projectManagement/login":"/login"
  ...
  cookies.set("cookieLogin","loginCookie",30*60);
...
function apiAxios(method, url, params,img) {
  ...
  //   httpDefault.headers.token = getUserInfo.token;
  // }
