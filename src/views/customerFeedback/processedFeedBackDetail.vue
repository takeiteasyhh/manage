<template>
  <div class="feedbackDetail whiteBac">
    ...
    <div class="feedbackDetailBox" style="min-height: 40%;">{{detailInfo.content}}</div>
    <div class="feedbackPerson">
      <div class="feedbackPersonList">
        <span>處理人：{{detailInfo.handleby}}</span>
        <span>處理時間：{{detailInfo.handletime}}</span>
      </div>
      <div class="feedbackPersonList">
        <span>所屬公司：{{detailInfo.handleCompany}}</span>
      </div>
      <div id="btnSubmitBox">
